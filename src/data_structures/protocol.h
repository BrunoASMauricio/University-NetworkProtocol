...
#define RETRANSMISSION_DELAY_NE_MIN 1*1E9		// 1 s
#define RETRANSMISSION_DELAY_NE_MAX 2*1E9		// 2 s

#define RETRANSMISSION_DELAY_NER_MIN 1*1E9	// 1 s
#define RETRANSMISSION_DELAY_NER_MAX 2*1E9	// 2 s
